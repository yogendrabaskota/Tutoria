...
const Footer = () => {
  return (
    <footer className="bg-teal-800 text-white pt-12 pb-6 px-6">
      <div className="max-w-6xl mx-auto">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-8">
          {/* Company Info */}
          <div>
            <h3 className="text-xl font-bold font-serif tracking-widest mb-4">
              T U T O R I A
            </h3>
        ...
        <div className="border-t border-teal-700 pt-6 flex flex-col md:flex-row justify-between items-center">
