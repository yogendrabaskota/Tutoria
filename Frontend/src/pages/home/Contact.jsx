      ...
      <div className="max-w-6xl mx-auto">
        <div className="text-center mb-16">
          ...
          <p className="text-gray-600 max-w-2xl mx-auto">
            Have questions about finding a tutor or becoming one? Reach out to
          ...
          <div className="lg:w-1/2">
            <div className="bg-white p-8 rounded-xl shadow-sm border border-gray-200">
              ...
              <form className="space-y-6">
                ...
                <button
                  type="submit"
                  className="w-full bg-teal-600 hover:bg-teal-700 text-white font-medium py-2 px-6 rounded-lg transition"
                >
                  Send Message
                </button>
              </form>
            ...
            <div className="bg-white p-8 rounded-xl shadow-sm border border-gray-200 h-full">
              ...
              <div className="space-y-6">
                ...
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600 mt-1">support@tutoria.com</p>
                    <p className="text-gray-600">info@tutoria.com</p>
                  </div>
                </div>
              </div>
              ...
              <div className="mt-10">
                ...
                <div className="flex space-x-4">
                  <a
                    href="#"
                    className="w-10 h-10 bg-teal-100 rounded-full flex items-center justify-center hover:bg-teal-200 transition"
                  >
                    <svg
                      className="w-5 h-5 text-teal-600"
                      fill="currentColor"
